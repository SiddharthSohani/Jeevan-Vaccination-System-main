...
const PartiallyVaccinated = () => {
  ...
  const [ partiallyVaccinationInfo , setPartiallyVaccinationInfo ] = useState([]);
    ...
    useEffect(()=>{
      const objectWeNeed = vaccinationInfo.filter((object) => {
        return object.partiallyVaccinated === true;
      });
      setPartiallyVaccinationInfo(objectWeNeed);
    },[vaccinationInfo])
    ...
    return (
      <>
        <div className="heading">
          <h6>List of PartiallyVaccinated vaccines taken by {name}.</h6>
        </div>
        <div className="vaccines">
        <ToastContainer/>
        {
          partiallyVaccinationInfo.length === 0 ?
          <>
          ...
          <>
          {
          partiallyVaccinationInfo.map((vaccine) => (
...
export default PartiallyVaccinated;
